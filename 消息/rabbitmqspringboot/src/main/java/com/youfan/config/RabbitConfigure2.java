...
public class RabbitConfigure2 {
    ...
    // 队列名称
    public final static String SPRING_BOOT_QUEUE = "beantest-queue-1";
    // 交换机名称
    public final static String SPRING_BOOT_EXCHANGE = "beantest-exchange-1";
    // 绑定的值
    public static final String SPRING_BOOT_BIND_KEY = "beantest-bind-key-1";
